...
const projectData = [
  {
    ...
    TechStack: ['React 18', 'Redux', 'TypeScript', 'TailwindCSS'],
    role: [
      '설문 데이터 퍼블리싱 및 개발',
      '챗봇 설문지 퍼블리싱 및 구현',
      '닉네임 검색 구현',
  ...
  },
  {
    ...
    images: [
      ...
      {
        description: '라운드 종료 화면',
        src: './images/wontouch/wontouch3.png',
      },
      {
        description: '작물가격 변동 화면',
        src: './images/wontouch/wontouch4.png',
      },
      {
        description: '마지막 라운드 종료 화면',
        src: './images/wontouch/wontouch5.png',
      },
  ...
  },
  {
    ...
    TechStack: ['React 18', 'Redux', 'TailwindCSS'],
    role: [
      '회원가입 / 로그인 퍼블리싱 및 구현',
      '지갑 / 송금페이지 퍼블리싱 및 구현',
      ...
      modalImages.innerHTML = project.images
        .map(
          ...
          <div class="image-container ${
            idx === arr.length - 1 && arr.length % 2 !== 0 ? '.last-image' : ''
          }">
